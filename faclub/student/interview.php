...
$interview_query = "SELECT p.Applicant_Name as Applicant_Name, a.Approval as Approval, a.Interview_Date as Interview_Date, a.Interview_Time as Interview_Time, a.Interview_Venue as Interview_Venue 
FROM application a JOIN applicant p ON a.Applicant_ID = p.Applicant_ID WHERE a.Approval IS NOT NULL AND a.Student_ID = ?";
...
<?php if (isset($application['Confirmation'])) { ?>
  ...
  <div class="arrow"><i class="fas fa-arrow-right"></i></div>
	...
	<br>
	<h2 style="text-align:center;font-weight:700;">Interview Table</h2><br>
    <br>
    <?php
            ...
            <table>
                ...
                while ($row = $interview_result->fetch_assoc()) {
                    if ($row["Approval"] != 'Pending') {
                        ...
                        echo "<td>" . $row["Interview_Venue"] . "</td>";
                        echo "</tr>";
