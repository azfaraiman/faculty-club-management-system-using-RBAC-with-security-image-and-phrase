...
$query1 = mysqli_query($conn, "SELECT * FROM club  WHERE Club_ID ='$faculty_student';");
$row1 = mysqli_fetch_array($query1);

$decrypted_email = decryptData($row1['Club_Email'], $key, $iv);
$decrypted_contact = decryptData($row1['Club_Contact'], $key, $iv);

$query2 = mysqli_query($conn, "SELECT m.Media_Content as Media_Content, m.Media_Description as Media_Description FROM media m JOIN club c ON m.Club_ID = c.Club_ID WHERE m.Club_ID = '$faculty_student';");
    ...
    <div style="margin-top: 20px; width: 80%;" class="container header-container-club">
      <div style="display: flex; align-items: center;">
        ...
        <div style="margin-left: 10px;">
          ...
          <b>Status Club Application: <span style="color: <?php echo ($status == 'Open') ? 'green' : 'red'; ?>;"><?php echo ucwords($status); ?></span></b><br><br>
          <a href="application.php" class="btn-submit">Register</a>
        </div>
      </div>
    </div>
    </div><br> 
